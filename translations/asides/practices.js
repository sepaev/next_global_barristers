  ...
  switch (lang) {
    ...
    default:
      paragraphs = {
        ...
        [familyLawHtml[0]]:
          'Категорія сімейних спорів охоплює безліч ситуацій, в яких може опинитися будь-яка людина. Деякі з них можуть здаватися вкрай складними або тривати роками, для інших достатньо просто приділити деякий час. Однак усі ситуації об’єднує спільна особливість – участь сімейного адвоката дозволяє вирішити проблему грамотно, з оптимальними часовими та грошовими витратами.',
        [taxLawHtml[0]]:
        ...
        [civilLawHtml[0]]:
          'Адвокати забезпечують юридичний супровід судової справи у судах першої, апеляційної та касаційної інстанцій, Верховному Суді. Самостійне виправлення вкрай рідко призводить до бажаного результату. Своєчасно надана допомога консультанта по судовій практиці дозволяє прорахувати та мінімізувати всілякі ризики',
        [customsLawHtml[0]]:
