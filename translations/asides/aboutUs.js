export function getTranslate(lang) {
  ...
  switch (lang) {
    case 'ru':
      ...
      lawersText =
        'Адвокат по корпоративным спорам;Адвокат по вопросам детей;Адвокат по взысканию дебиторской задолженности;Адвокат по спорам по недвижимости;Адвокат по разделу имущества;Адвокат по банковским и финансовым спорам;Адвокат по госзакупкам;Адвокат по судебным спорам'
      actionsText =
